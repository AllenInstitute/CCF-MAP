...
The HOMBA Adult Marmoset Atlas is a three-dimensional brain reference atlas based on the RIKEN25v1 MRI-derived template, based on an average of 25 *C. jacchus* brains resampled to 70 um<sup>3</sup> voxel resolution. It provides detailed parcellations of the basal ganglia and associated subcortical structures, annotated using the [Harmonized Ontology of Mammalian Brain Anatomy (HOMBA)](../docs/HOMBA_ontology_v1.md) 
