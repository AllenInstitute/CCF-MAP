...
CCF data assets are hosted on a public S3 bucket on Amazon Web Services (AWS) **here**. All data assets described in this repository are available publicly with no account or login required for access. 
