...
- The HOMBA ontology is available for offline access in [**csv**](../_static/HOMBA_v1.1.0.csv) and [**json**](../_static/HOMBA_v1.1.0.json) formats. The csv also contains columns for mapping HOMBA to DHBA values.
